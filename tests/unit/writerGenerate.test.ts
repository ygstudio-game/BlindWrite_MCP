...
describe('WriterGenerate and directWrite', () => {
  ...
  it('defaults to priority model GLM 5.3 when no model is specified and no rankings exist', async () => {
    vi.spyOn(service.openRouterService, 'generateOutput').mockResolvedValue({
      modelId: 'glm-5-3',
      outputText: 'Draft content generated by default.',
      promptTokens: 30,
      completionTokens: 80,
      totalTokens: 110,
      latencyMs: 450,
    ...
    expect(result.selectionReason).toContain('GLM 5.3');
